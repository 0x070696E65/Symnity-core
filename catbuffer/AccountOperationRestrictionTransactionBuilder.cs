...
namespace Symbol.Builders {
    ...
    */
    ...
    public class AccountOperationRestrictionTransactionBuilder: TransactionBuilder {
        ...
        */
        internal AccountOperationRestrictionTransactionBuilder(SignatureDto signature, PublicKeyDto signerPublicKey, byte version, NetworkTypeDto network, TransactionTypeDto type, AmountDto fee, TimestampDto deadline, List<AccountRestrictionFlagsDto> restrictionFlags, List<TransactionTypeDto> restrictionAdditions, List<TransactionTypeDto> restrictionDeletions)
