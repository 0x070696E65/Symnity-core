...
Announce a NodeKeyLinkTransaction to link an account with a public key used by TLS to create sessions.
    */
    ...
    public class NodeKeyLinkTransactionBuilder: TransactionBuilder {
        ...
        */
        internal NodeKeyLinkTransactionBuilder(SignatureDto signature, PublicKeyDto signerPublicKey, byte version, NetworkTypeDto network, TransactionTypeDto type, AmountDto fee, TimestampDto deadline, PublicKeyDto linkedPublicKey, LinkActionDto linkAction)
        ...
        * @return Instance of NodeKeyLinkTransactionBuilder.
        */
        public static  NodeKeyLinkTransactionBuilder Create(SignatureDto signature, PublicKeyDto signerPublicKey, byte version, NetworkTypeDto network, TransactionTypeDto type, AmountDto fee, TimestampDto deadline, PublicKeyDto linkedPublicKey, LinkActionDto linkAction) {
