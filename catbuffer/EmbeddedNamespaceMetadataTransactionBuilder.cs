...
namespace Symbol.Builders {
    ...
    */
    ...
    public class EmbeddedNamespaceMetadataTransactionBuilder: EmbeddedTransactionBuilder {
        ...
        */
        internal EmbeddedNamespaceMetadataTransactionBuilder(PublicKeyDto signerPublicKey, byte version, NetworkTypeDto network, TransactionTypeDto type, UnresolvedAddressDto targetAddress, long scopedMetadataKey, NamespaceIdDto targetNamespaceId, short valueSizeDelta, byte[] value)
        ...
        * @return Instance of EmbeddedNamespaceMetadataTransactionBuilder.
        */
        public static  EmbeddedNamespaceMetadataTransactionBuilder Create(PublicKeyDto signerPublicKey, byte version, NetworkTypeDto network, TransactionTypeDto type, UnresolvedAddressDto targetAddress, long scopedMetadataKey, NamespaceIdDto targetNamespaceId, short valueSizeDelta, byte[] value) {
