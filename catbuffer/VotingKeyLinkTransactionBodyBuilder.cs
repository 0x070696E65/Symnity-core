...
namespace Symbol.Builders {
    ...
    */
    ...
    public class VotingKeyLinkTransactionBodyBuilder: ISerializer {
        ...
        public VotingPublicKeyDto linkedPublicKey;
        ...
        */
        ...
        {
            try {
                linkedPublicKey = VotingPublicKeyDto.LoadFromBinary(stream);
        ...
        */
        internal VotingKeyLinkTransactionBodyBuilder(VotingPublicKeyDto linkedPublicKey, FinalizationEpochDto startEpoch, FinalizationEpochDto endEpoch, LinkActionDto linkAction)
        {
        ...
        * @return Instance of VotingKeyLinkTransactionBodyBuilder.
        */
        public static  VotingKeyLinkTransactionBodyBuilder Create(VotingPublicKeyDto linkedPublicKey, FinalizationEpochDto startEpoch, FinalizationEpochDto endEpoch, LinkActionDto linkAction) {
