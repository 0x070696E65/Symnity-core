...
namespace Symbol.Builders {
    ...
    */
    ...
    public class AccountAddressRestrictionTransactionBuilder: TransactionBuilder {
        ...
        */
        internal AccountAddressRestrictionTransactionBuilder(SignatureDto signature, PublicKeyDto signerPublicKey, byte version, NetworkTypeDto network, TransactionTypeDto type, AmountDto fee, TimestampDto deadline, List<AccountRestrictionFlagsDto> restrictionFlags, List<UnresolvedAddressDto> restrictionAdditions, List<UnresolvedAddressDto> restrictionDeletions)
