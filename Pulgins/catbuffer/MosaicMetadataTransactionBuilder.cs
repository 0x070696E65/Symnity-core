...
Compare to AccountMetadataTransaction and NamespaceMetadataTransaction.
    */
    ...
    public class MosaicMetadataTransactionBuilder: TransactionBuilder {
        ...
        * @return Instance of MosaicMetadataTransactionBuilder.
        */
        public static  MosaicMetadataTransactionBuilder Create(SignatureDto signature, PublicKeyDto signerPublicKey, byte version, NetworkTypeDto network, TransactionTypeDto type, AmountDto fee, TimestampDto deadline, UnresolvedAddressDto targetAddress, long scopedMetadataKey, UnresolvedMosaicIdDto targetMosaicId, short valueSizeDelta, byte[] value) {
