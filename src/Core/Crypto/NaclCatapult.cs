...
namespace Symnity.Core.Crypto
{
    public static class NaclCatapult
    {
        ...
        static byte[] _0 = new byte[16];
        static byte[] _9 = new byte[32];

        private static long[] gf0 = Gf();
        private static long[] gf1 = Gf(new long[]{1});
        private static long[] _121665 = Gf(new long[]{0xdb41, 1});
        private static long[] D = Gf(new long[]{
            0x78a3,
            0x1359,
            0x4dca,
            0x75eb,
            ...
            0x6cee,
            0x5203});
        private static long[] D2 = Gf(new long[]{
            0xf159,
            0x26b2,
            0x9b94,
            0xebd6,
        ...
        private static long[] Y = Gf(new long[]{
            ...
            0x6666,
            0x6666});
        private static long[] I = Gf(new long[]{
            0xa0b0,
            0x4a0e,
            0x1b27,
            0xc4ee,
